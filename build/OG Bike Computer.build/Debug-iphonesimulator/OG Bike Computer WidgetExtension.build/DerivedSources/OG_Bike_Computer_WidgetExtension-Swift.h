...
#ifndef OG_BIKE_COMPUTER_WIDGETEXTENSION_SWIFT_H
#define OG_BIKE_COMPUTER_WIDGETEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OG_Bike_Computer_WidgetExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
